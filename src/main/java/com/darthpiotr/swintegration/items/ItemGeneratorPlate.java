...
public class ItemGeneratorPlate extends Item {
	public final String name = "generatorPlate";

	public ItemGeneratorPlate() {
		this.setMaxDamage(0);
    ...
    {
            this.itemIcon = iReg.registerIcon(Reference.TexturesIcons.GENERATOR_PLATE);
    }
}
